...
import edu1 from "./img/edutube-project/edu1.PNG";
import edu2 from "./img/edutube-project/edu2.PNG";
import edu3 from "./img/edutube-project/edu3.PNG";
import edu4 from "./img/edutube-project/edu4.PNG";
  ...
  const my_projects = [
    {
      ...
      name: "Movies-Ranking",
      description:
        "This Website allows you to discuss your Movies,Series,Anime and rate them with multiple users,as each rating affects the overall score of the movie.Search for movies posted by Users and filter them according to your liking",
    ...
    },
    {
      ...
      name: "Chat App",
      description:
        "This Chat App allows users to create chat rooms and add multiple users to any chat,thus leading to a collaboration among a community of like-minded people",
    ...
    },
    {
      ...
      name: "EduTube",
      description:
        "EduTube is a project that I just started working on which serves as a platform to share educational files.It is basically a Youtube clone dedicated for learning",
      img: [edu1, edu2, edu3, edu4],
      technologies: [
        "Node JS",
        "Express JS",
        "React JS",
  ...
  return (
    <div className="project component__space" id="Portfolio">
      <div className="heading">
        ...
        <p className="heading p__color">Below is a collection of my</p>
        <p className="heading p__color">Personal Projects</p>
      </div>
        ...
        <div className="row">
          {!moreDetails &&
            my_projects.map((proj) => {
              return (
                <div id={proj.id} className="col__3">
                  <div className="project__box pointer relative">
                    ...
                    <div className="project__meta absolute">
                      ...
                      <h4 className="project__text description">
                        {proj.description.slice(0, 150)}...
                      </h4>
                      <h4 className="project__tech">
                        {proj.technologies.map((tech, id) => {
                          return <div className="curr_tech"> {tech}</div>;
                        })}
                      </h4>
                      <p style={{ marginTop: "4.5rem" }}>
                        <i class="fas fa-globe" style={{ color: "#DDDDDD" }}>
                          <a href={proj.link} style={{ marginLeft: "10px" }}>
                            Link to Project
                          </a>
                        </i>
                      </p>
